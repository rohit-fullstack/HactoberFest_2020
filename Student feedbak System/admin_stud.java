...
import java.io.*;
import java.util.*;
public class admin_stud extends JFrame implements ActionListener{
    static admin_stud h1;
    ...
    int n=0,id=0;
    String select,new_stud;
    String name[]=new String[100];
    String pass[]=new String[100];
    admin_stud(String str1)
    {
        super(str1);
    ...
    public void getData()
    {
        String t="";
        try{            
            fis=new FileInputStream("stud_rec.txt");
            sc=new Scanner(fis);
        }catch(Exception ex){
    ...
    public void remove(String str)
    {
        ...
        this.dispose();
        h1=new admin_stud("Admin studher");            
        JOptionPane.showMessageDialog(this, "Succesfully removed !");
    }
     public void add()
    {
        try{            
            fos=new FileOutputStream("stud_rec.txt",true);
            dos=new DataOutputStream(fos);
             dos.writeBytes(new_stud);
             dos.close();
             fos.close();
               }catch(Exception e){JOptionPane.showMessageDialog(this,e);}
        this.dispose();
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(o==add)
        {          
           new_stud="\n"+JOptionPane.showInputDialog("Enter student name and password");
           add();
        }
        else if(o==remove)
        {
